    ...
    return (<div className="min-h-screen bg-background">
      ...
      <div className="pt-16">
        <div className="bg-secondary text-secondary-foreground py-12 px-4 text-center">
          <h1 className="text-4xl font-bold mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Tourist Attractions</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[...attractions, ...attractions].map((attr, i) => (<div key={i} className="card-travel group overflow-hidden flex flex-col md:flex-row">
                <div className="relative overflow-hidden md:w-48 flex-shrink-0">
                  <img src={attr.image} alt={attr.name} className="w-full md:w-48 h-48 object-cover group-hover:scale-105 transition-transform duration-500" onError={(e) => {
